...
var vistogram = visualizer.extend({
	...
	insertHTML: function(divclass) {
	    $('#terminalWindow').attr('style','width: 650px; height:400px;');	    
	    $('div.'+divclass).html('\
...
<tr>\
  ...
  <td><img class="codebutton" src="assets/img/loadex.png" id="ASSUME g (flip 0.5)"/></td>\
